        ...
        child: Padding(
          ...
          child: Image.network(
            ...
            errorBuilder: (context, error, stackTrace) {
              // Fallback to Material icons if images fail to load
              IconData fallbackIcon;
              if (imageUrl.contains('email')) {
                fallbackIcon = Icons.email;
              } else if (imageUrl.contains('phone')) {
                fallbackIcon = Icons.phone;
              } else if (imageUrl.contains('location')) {
                fallbackIcon = Icons.location_on;
              } else if (imageUrl.contains('time')) {
